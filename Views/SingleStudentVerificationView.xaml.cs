...
{
    /// <summary>
    /// SingleStudentVerificationView.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class SingleStudentVerificationView : UserControl
    {
        private SingleStudentVerificationViewModel ViewModel => (SingleStudentVerificationViewModel)DataContext;
        private bool _isUpdatingCanvas = false;

        public SingleStudentVerificationView()
        {
            InitializeComponent();
            Loaded += View_Loaded;
        }
        ...
        private void ViewModel_PropertyChanged(object? sender, PropertyChangedEventArgs e)
        {
            ...
            {
                Logger.Instance.Error("SingleStudentVerificationView - ViewModel_PropertyChanged 실패", ex);
            }
        }
        ...
        private void UpdateImageDisplay()
        {
            ...
            {
                Logger.Instance.Error("SingleStudentVerificationView - UpdateImageDisplay 실패", ex);
            }
        }
